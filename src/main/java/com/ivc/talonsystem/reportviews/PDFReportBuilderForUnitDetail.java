...
public class PDFReportBuilderForUnitDetail extends AbstractITextPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document doc, PdfWriter writer,
		...
		/*Report requirements:*/
			List<UnitDepart> unitlist=(List<UnitDepart>) model.get("companies");
		...
		/*header*/
			...
			sb.append("ОТЧЕТ\r\n" + 
					"О ПРИЧИНАХ ИЗЪЯТЫХ ТАЛОНОВ-ПРЕДУПРЕЖДЕНИЯ № 1, 2, 3 ПО ПРЕДПРИЯТИЯМ ДОРОЖНОГО ПОДЧИНЕНИЯ АО \"УТЙ\" ");
