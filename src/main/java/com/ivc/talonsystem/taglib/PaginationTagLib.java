package com.ivc.talonsystem.taglib;
	...
	private String uri;
	 ...
	 public void doTag() throws JspException {
	  ...
	  try {
	   ...
	   out.write("<ul class=\"pagination pagination-basic mg-b-0\">");
	   ...
	   for(int itr=0;itr<count;itr+=steps) {
	    if(offset==itr)
	     out.write(constructLink((itr/10+1)-1 *steps, String.valueOf(itr/10+1), "page-item active", true));
	    else
	 ...
	 private String constructLink(int page, String text, String className, boolean disabled) {
	  ...
	  if(disabled)
	   link.append(">").append("<a href=\"#\" class=\"page-link\">"+text+"</a></li>");
	  else
	   link.append(">").append("<a href=\""+uri+"?offset="+page + "\" class=\"page-link\">"+text+"</a></li>");
