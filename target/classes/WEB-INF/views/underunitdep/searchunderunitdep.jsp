	...
	<div class="modal-dialog modal-dialog-vertical-center" role="document">
		<div class="modal-content bd-0 tx-14">
			<div class="modal-header pd-y-20 pd-x-25">
				<h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Поиск подразделений служб</h6>
			...
			<div class="modal-body pd-25">
				<div class="mg-b-5">
					<div class="card pd-20 pd-sm-40 form-layout form-layout-4">
						<h6 class="card-body-title">Поиск подразделений служб по названию</h6>
						<p class="mg-b-20 mg-sm-b-30">Введите название подразделении.</p>
						<form method="GET" action="${pageContext.request.contextPath}/searchUnderUnit">
							<div class="row">
								<label class="col-sm-4 form-control-label">Название: <span
									class="tx-danger">*</span></label>
								<div class="col-sm-8 mg-t-10 mg-sm-t-0">
									<input type="text" name="underunitname" class="form-control"
