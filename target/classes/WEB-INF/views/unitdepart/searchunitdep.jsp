	...
	<div class="modal-dialog modal-dialog-vertical-center" role="document">
		<div class="modal-content bd-0 tx-14">
			<div class="modal-header pd-y-20 pd-x-25">
				<h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Поиск службы</h6>
			...
			<div class="modal-body pd-25">
				<div class="mg-b-5">
					<div class="card pd-20 pd-sm-40 form-layout form-layout-4">
						<h6 class="card-body-title">Поиск службы по названию</h6>
						<p class="mg-b-20 mg-sm-b-30">Введите название службы.</p>
						<form method="GET" action="${pageContext.request.contextPath}/searchUnit">
							<div class="row">
