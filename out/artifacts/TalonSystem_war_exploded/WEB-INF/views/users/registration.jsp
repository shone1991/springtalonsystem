...
<body>
	<div class="generic-container">
		...
		<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="idabstractcompany">Companies</label>
					<div class="col-md-7">
						...
						<c:choose>
							<c:when test="${edit}">
								<form:input type="text" path="company.callname" id="callname"
									list="companylist" class="form-control input-sm" />
							</c:when>
							<c:otherwise>
								<form:input type="text" path="company.callname" id="callname"
									list="companylist" class="form-control input-sm" />
					...
					<c:choose>
						<c:when test="${edit}">
							<input type="submit" value="Update"
								...
								href="<c:url value='/users/list' />">Cancel</a>
						</c:when>
						<c:otherwise>
